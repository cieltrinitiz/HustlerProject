...
if (!remixRewardPool.includes("interface IERC20Remix") || !remixRewardPool.includes("contract GoodLearnRewardPoolRemix")) {
  throw new Error("Remix reward pool must include inline interfaces");
}
